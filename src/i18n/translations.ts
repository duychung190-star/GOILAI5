...
export const translations = {
  vi: {
    ...
    summary: {
      ...
      waitingFeeNoteBody: "Tổng tiền chưa bao gồm phí chờ (40.000 VNĐ / 30 phút chờ), phí phát sinh điểm dừng. (Lưu ý: Giá trên chưa bao gồm hỗ trợ chi phí ăn ở cho tài xế).",
