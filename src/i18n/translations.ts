...
export const translations = {
  vi: {
    ...
    form: {
      ...
      phonePlaceholder: "Nhập số điện thoại (vd: 0971999734)",
  ...
  en: {
    ...
    form: {
      ...
      phonePlaceholder: "Enter phone number (e.g., 0971999734)",
  ...
  zh: {
    ...
    form: {
      ...
      phoneLabel: "联系电话",
      phonePlaceholder: "请输入电话号码 (例如: 0971999734)",
  ...
  ja: {
    ...
    form: {
      ...
      phoneLabel: "電話番号",
      phonePlaceholder: "電話番号を入力 (例: 0971999734)",
  ...
  ko: {
    ...
    form: {
      ...
      phoneLabel: "연락처",
      phonePlaceholder: "전화번호 입력 (예: 0971999734)",
