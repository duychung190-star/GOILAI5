...
export const InteractiveMap: React.FC<InteractiveMapProps> = ({
  ...
  return (
    <div className="relative w-full h-full min-h-[300px] rounded-xl overflow-hidden border border-slate-700/80 shadow-inner bg-slate-950">
      ...
      {/* Legend overlay */}
      <div className="absolute bottom-3 left-3 z-[400] bg-slate-900/90 backdrop-blur-md px-3 py-2 rounded-lg border border-slate-700 text-xs text-slate-200 shadow-md space-y-1">
        <div className="flex items-center gap-2">
          <span className="w-3 h-3 rounded-full bg-emerald-500 border border-white inline-block"></span>
          <span className="font-semibold text-slate-200">Điểm đón:</span>
          <span className="text-slate-400 truncate max-w-[150px] sm:max-w-[200px]">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-slate-200">Điểm đến:</span>
          <span className="text-slate-400 truncate max-w-[150px] sm:max-w-[200px]">
